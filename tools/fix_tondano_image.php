...
echo "=== FIXING DANAU TONDANO IMAGE ===" . PHP_EOL . PHP_EOL;

// Find the wisata
$wisata = Wisata::where('name', 'Danau Tondano')->first();

if (!$wisata) {
    echo "✗ Wisata 'Danau Tondano' not found!" . PHP_EOL;
    exit(1);
}
...
$imagePath = 'images/wisata/Danau Tondano.jpg';
